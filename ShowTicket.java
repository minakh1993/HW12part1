...
public class ShowTicket extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (ticket != null) {
			...
			out.println(ticket.getCustomerName());
			out.println("<br>");
			out.print("origin:");
			out.println(ticket.getOrigin());
			out.println("<br>");
			out.print("destination:");
			out.println(ticket.getDestination());
			out.println("<br>");
			out.print("flight number:");
			out.println(ticket.getFlightNumber());
			out.println("<br>");
			out.print("date:");
			out.println(ticket.getDate());
			out.println("<br>");
